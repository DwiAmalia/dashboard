        ...
        <div class="container container--xl">
            ...
            <div class="py-res-120">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <h2>500</h2>
                        <h3 class="mb-32 max-w-1000-px">Internal Server Error</h3>
                        <p class="text-neutral-500 max-w-700-px text-lg">Something went wrong on our end. We're working to fix it.
